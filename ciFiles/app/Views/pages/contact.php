        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-12 col-sm-12 d-none d-lg-block" style="margin-top: 2em; margin-bottom: 2em;">
                    ...
                    <p style="font-size: 1.4em; margin-bottom: 0;" class="text-dark">Contact Number: 9967491105, 8419977612 </p>
                    <p style="font-size: 1.4em; margin-bottom: 0;" class="text-dark">Email: hello@travelbuddys.in</p>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 d-block d-lg-none" style="margin-top: 2em; margin-bottom: 2em;">
                    <h2 class="text-dark">Contact Info:</h2>
                    <p style="font-size: 1.4em; margin-bottom: 0;" class="text-dark">Contact Number: <br> 9967491105, 8419977612 </p>
                    <p style="font-size: 1.4em; margin-bottom: 0;" class="text-dark">Email: hello@travelbuddys.in</p>
                    <p style="font-size: 1.4em; margin-bottom: 0;" class="text-dark">Location: Mumbai, India</p>
                </div>
                <div class="col-lg-6 col-md-12 col-sm-12 text-left text-dark">
                    ...
                    <form action="<?php echo site_url('send-contact-email'); ?>" method="post">
